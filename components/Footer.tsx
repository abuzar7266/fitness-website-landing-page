        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="mb-8 md:mb-0">
            <Link href="/" className="flex items-center mb-4">
              ...
              <span className="ml-2 text-xl font-bold">Gymify</span>
            </Link>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/trainers" className="text-gray-400 hover:text-white">Trainers</Link></li>
              <li><Link href="/diet-plans" className="text-gray-400 hover:text-white">Diet Plans</Link></li>
          ...
          <div>
            ...
            <p className="text-gray-400 mb-4">Stay up to date with our latest news and products.</p>
            <form className="flex">
              <input
                type="email"
